...
from farabio.models.classification.conv.mobilenetv2 import ConvBNActivation
from farabio.utils.helpers import _make_divisible, get_num_parameters
...
class SqueezeExcitation(nn.Module):
    ...
    def _scale(self, inp: torch.Tensor) -> torch.Tensor:
        scale = F.adaptive_avg_pool2d(inp, 1)
    ...
    **kwargs: Any
    ...
    if arch == 'mobilenet_v3_large':
        ...
        inverted_residual_setting = [
            ...
            bneck_conf(48, 5, 288, 96, True, 'HS', 2, 1),
