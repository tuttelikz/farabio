...
def _cfg_yolov3():
    ...
    return {
        # Data
        'batch_size': 8,
        'data_config': '/home/suzy/gitrepos/tuttelikz/farabi/farabi/models/detection/yolov3/config/coco.data',
        'img_size': 416,
        # Model
        'model_def': '/home/suzy/gitrepos/tuttelikz/farabi/farabi/models/detection/yolov3/config/yolov3.cfg',
