...
Default methods
^^^^^^^^^^^^^^^^^^^^^^^^^
* :py:meth:`~.GanTrainer.init_attr`
* :py:meth:`~.GanTrainer.get_trainloader`
* :py:meth:`~.GanTrainer.get_testloader`
* :py:meth:`~.GanTrainer.build_model` | :py:meth:`~.GanTrainer.build_parallel_model`

Methods to initalize class attributes
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
* :py:meth:`~.GanTrainer.define_data_attr`
* :py:meth:`~.GanTrainer.define_model_attr`
* :py:meth:`~.GanTrainer.define_train_attr`
* :py:meth:`~.GanTrainer.define_test_attr`
* :py:meth:`~.GanTrainer.define_log_attr`
* :py:meth:`~.GanTrainer.define_compute_attr`
* :py:meth:`~.GanTrainer.define_misc_attr`

Native methods
^^^^^^^^^^^^^^^^^^^^^^^^^
* :py:meth:`~.GanTrainer.discriminator_zero_grad()`
* :py:meth:`~.GanTrainer.discriminator_loss()`
* :py:meth:`~.GanTrainer.discriminator_backward()`
* :py:meth:`~.GanTrainer.discriminator_optim_step()`

* :py:meth:`~.GanTrainer.generator_zero_grad()`
* :py:meth:`~.GanTrainer.generator_loss()`
* :py:meth:`~.GanTrainer.generator_backward()`
* :py:meth:`~.GanTrainer.generator_optim_step()`

* :py:meth:`~.GanTrainer.load_model`
* :py:meth:`~.GanTrainer.save_model`
